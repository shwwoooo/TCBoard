...
void ADS131M04::begin(SPIClass *spi, uint8_t clk_pin, uint8_t miso_pin, uint8_t mosi_pin, uint8_t cs_pin, uint8_t drdy_pin)
{
  // Set pins up
  ...
  spi->setMISO(ADS131M04_MISO_PIN);
  spi->setMOSI(ADS131M04_MOSI_PIN);
