...
void ADS131M04::begin(void) {
  ...
  analogWriteFrequency((uint8_t) this->clkoutPin, 10);
  analogWrite(this->clkoutPin, 128);
  // Set CLKOUT on the ESP32 to give the correct frequency for CLKIN on the ADC
